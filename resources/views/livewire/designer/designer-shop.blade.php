            ...
            <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img src="{{ asset('uploads/images/' . $store->cover) }}" class="d-block" alt="..." width="1010" height="392">
                    <div class="position-absolute" style="top :110px; left : 30px">
                    <img src="{{ asset('uploads/images/' . $store->image) }}" alt="" width="150" class="rounded-circle img-thumbnail" >
        ...
        <div class="row mt-3">
            <div class="tabs">
                ...
                <div class="tabs_content mt-3">
                    <div class="row">
                        <div class="col-lg-12">
                            <select class="form-select border border-dark rounded-0" style="width:15rem;" wire:model="categoryProductId">
                        ...
                        @forelse ($uploadProductDesigns as $uploadProductDesign)
                            <div class="col-lg-2 col-6 mt-2">
                                <a href="{{ route('products.show', $uploadProductDesign->id) }}" class="text-decoration-none text-dark"><div class="card child-card border-0">
                                    <img src="{{ $uploadProductDesign->uploadProductDesignVariants[0]->image }}" class="" alt="..." style="border : 0.5px solid black">
                ...
                <div class="tabs_content mt-3">
                    <div class="row">
                        <div class="col-lg-12">
                            <select class="form-select border border-dark rounded-0" style="width:15rem;" wire:model="designCategoryId">
                    ...
                    <div class="row mt-2" style="gap : 2rem">
                        @forelse ($productDesigns as $productDesign)
                            <div class="col-lg-2 col-6 mt-2">
                                <a href="" class="text-decoration-none text-dark"><div class="card child-card border-0">
                                    ...
                                    <div class="card-body mt-2 p-0">
                                        ...
                                        <h6 class="mt-2" style="font-family: 'Myriad-Pro Bold';">Rp. {{ number_format($productDesign->total_price, 0, ',','.') }}</h6>
                                    </div>
                                </div>
                            </a>
                            </div>
