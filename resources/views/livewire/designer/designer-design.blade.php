            ...
            @foreach ($uploadProductDesigns as $uploadProductDesign)
                <div class="col-lg-5">
                    ...
                    <div class="d-flex justify-content-center mt-2">
                        <button class="btn btn-warning text-center">Desain Menunggu Verifikasi  <i
                ...
                <div class="col-lg-7">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="exampleFormControlInput1"
                            value="{{ $uploadProductDesign->id }}" disabled>
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Judul</label>
                        <input type="text" class="form-control" id="exampleFormControlInput1"
                            value="{{ $uploadProductDesign->title }}" disabled>
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Deskripsi</label>
                        <input type="text" class="form-control" id="exampleFormControlInput1"
                            value="{{ $uploadProductDesign->description }}" disabled>
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Kategori</label>
                        <input type="text" class="form-control" id="exampleFormControlInput1"
                            value="{{ $uploadProductDesign->designCategory->name }}" disabled>
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Tags</label>
                        <input type="text" class="form-control" id="exampleFormControlInput1"
                            value="{{ $uploadProductDesign->tags }}" disabled>
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">URL</label>
                        <input type="text" class="form-control" id="exampleFormControlInput1"
                            value="{{ $uploadProductDesign->url }}" disabled>
                    </div>
                </div>
            @endforeach
        </div>
                        ...
                        <div class="card child-card border-0">
                            ...
                            <div class="card-body mt-2 p-0">
                                <p class="card-title" style="font-family: 'Myriad-Pro Bold';">ID :
                                    {{ $uploadProductDesignApproved->id }}</p>
