        ...
        <div class="col-md-6 card px-3 py-3 shadow">
            <form action="" method="POST" wire:submit.prevent="register">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="password" wire:model="password_confirmation" class="form-control @error('password') is-invalid @enderror" required>
                    @error('password')
                        <span class="invalid-feedback">
                                {{ $message }}
                         </span>
                ...
                <div class="mb-3 d-flex justify-content-around">
                    <div class="form-check">
                        ...
                        <input class="form-check-input" wire:model="role_id" type="radio" name="role" checked value="3" required>
                        <label class="form-check-label" for="role">
                          User
                        </label>
                      </div>
                    <div class="form-check">
                        <input class="form-check-input" wire:model="role_id" type="radio" name="role"value="2" required>
                        <label class="form-check-label" for="role">
                            Designer
                        </label>
                      </div>
